...
<head>
    ...
    <script type="text/javascript">
        ...
        //         $("#lastupdatetime").text(formatterdate(row.last_update_time));
        ...
        <fieldset style="width:900px;border:solid 1px #aaa;margin-top:8px;position:relative;">
            ...
            <table class="ht-table"  width="100%" border="0">
                <tr>
                    ...
                    <td><input class="easyui-textbox" type="text" id="thread_acceptance_criteria_no" name="thread_acceptance_criteria_no" value=""/></td>
                    <td>
                        <a href="#" class="easyui-linkbutton i18n1" name="createstandardno" onclick="addAcceptanceCriteriaFunction()">生成标准编号</a>
                    </td>
                </tr>
                <%--<tr>--%>
                    <%--<td class="i18n1" name="lastupdatetime"></td>--%>
                    <%--<td colspan="5">--%>
                        <%--<label id="lastupdatetime" class="hl-label"></label>--%>
                        <%--&lt;%&ndash;<input class="easyui-datetimebox" type="text" id="timearg1" name="timearg1" value="" data-options="formatter:myformatter2,parser:myparser2"/>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<input class="easyui-textbox" type="text" name="last_update_time" value=""/>&ndash;%&gt;--%>
                    <%--</td>--%>
                <%--</tr>--%>
            </table>
        </fieldset>
