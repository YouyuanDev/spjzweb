...
public class ThreadAcceptanceCriteriaController {
    ...
    @ResponseBody
    public String saveThreadAcceptanceCriteria(ThreadingAcceptanceCriteria threadAcceptanceCriteria, HttpServletRequest request, HttpServletResponse response){
